...
import { marketingNavigationMenu } from "../_config/marketing-routes.config";
...
export default function Navbar() {
  ...
  return (
    <>
      <motion.header
        className={`fixed top-0 w-full z-[9999] border-b py-2  bg-background left-0  transition-all duration-500`}
        initial="hidden"
        animate="visible"
      >
                    ...
                    {item.subItems ? (
                      <>
                        ...
                        <NavigationMenuContent>
                          ...
                          >
                            {/* Removed the 'Features' specific ListItem as it's not in the new nav structure */}
                            ...
                            {openMobileSubmenu === item.name && (
                              ...
                              >
                                <div className="ml-4 mt-1 space-y-1 border-l border-muted-foreground/30 pl-4">
                                  {" "}
                                  {/* Indent and add a subtle border */}
                                  {item.subItems.map((subItem) => (
                                    <motion.div
                                      key={subItem.name}
